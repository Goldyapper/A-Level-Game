...
difficulty_menu = False#sets difficulty menu as true, meaning it will be displayed straight away
main_menu = True
#time variables
...
###for background###
    ...
    #main menu#
Main_menu_BG_img = pygame.image.load('images/Main_menu_BG.png')

    #difficulty menu#
Difficulty_select_BG_img = pygame.image.load('images/Difficulty_select_BG.png')

    #display timer#
Display_timer_BG_1 = pygame.image.load('images/Display_timer_BG_1.png')
Display_timer_BG_2 = pygame.image.load('images/Display_timer_BG_2.png')
Display_timer_BG_3 = pygame.image.load('images/Display_timer_BG_3.png')
