...
while run:#if run is ture
    ...
    if main_menu:#if main menu is true
        ...
        if action_guide:#if the difficulty menu is being displayed
            ...
            Screen.blit (Action_guide_BG_img,(0,0))#shows the background image of the difficulty menu
            
            if Return_to_main_menu_button.draw():#restart button is drawn
                main_menu = True #main menu is opened5
                action_guide = False#difficulty menu is opened
