...
font = pygame.font.SysFont('Arial', 32)#imports the font arial and the size of 32 to be used later
...
difficulty_menu = True#sets difficulty menu as true, meaning it will be displayed straight away
...
#for background#
Difficulty_select_BG_img = pygame.image.load('images/Difficulty_select_BG.png')
#########################################################################################
                                     ###Opening the screen###
#########################################################################################
...
###buttons###
Return_to_main_menu_button = Button(Screen_width//2 -30, Screen_height//2,Return_to_main_menu_img)
...
while run:#game loop
    ...
    ###when main menu is coded and it here and indent below
    if difficulty_menu == True:#if the difficulty menu is being displayed
        ...
        platform_group.draw(Screen)#draws the coin onto the screen
        ...
        if timer == True:
            ...
            time_passed = (f'{minutes} Minutes {seconds} Seconds {centiseconds} mili-secondss')
            print(time_passed)
            time.sleep(.01)
            seconds = int(time.time() - time_start) - minutes * 60
            centiseconds = round(time.time() - time_start - seconds, 2)
            if seconds >= 60:
                minutes += 1
                seconds = 0
        ...
        if game_over == 0:#if the player has neither died or completed a level
            ...
            draw_text('X  ' + str(coin_count),font, white, tile_size*1.25, -2)#converts score into a string and displays it at the top left of the screen as white text in the desird font
            draw_text('X  ' + str(player.lives),font, white,Screen_width - (tile_size*1.75), -2)#converts score into a string and displays it at the top left of the screen as white text in the desird font
