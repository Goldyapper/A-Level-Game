...
###buttons###
Start_game_button = Button(55,162, Start_game_img)#creates a start game button instance at give co-ords and loads the given image
Action_guide_button = Button(55,287, Action_guide_img)#creates an action guide button instance at give co-ords and loads the given image
Exit_button = Button(55,412, Close_img)#creates an close button instance at give co-ords and loads the medium image
